...
<div id="base_text_topo_local_pagina" class="text_barra_title_pagina">Modera&ccedil;&atilde;o / Comentarios noticias</div>
<div id="content_title_pagina" class="title_pagina_barra"><span class="text_barra_title_pagina">Comentarios noticias</span></div>
</div>
<script>
var apagar = {
	sim:function(id){
...
if($tipo == 'apagar'){
	$id = (int) $_GET['id'];
	db::Query("DELETE FROM noticias_comentarios WHERE id='$id'");
	echo('deu');
}else{
?>
<table width="100%">
    ...
    <?php
	$i = 1;
    $sql = db::Query("SELECT * FROM noticias_comentarios ORDER BY id DESC LIMIT 50");
    ...
    <tr>
        ...
        <th<?php echo $css; ?>><?php echo $ver['id_noticia']; ?></th>
