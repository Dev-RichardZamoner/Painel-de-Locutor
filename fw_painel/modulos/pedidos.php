...
<div id="base_text_topo_local_pagina" class="text_barra_title_pagina">Locu&ccedil;&atilde;o / Pedidos</div>
<div id="content_title_pagina" class="title_pagina_barra"><span class="text_barra_title_pagina">Pedidos</span></div>
</div>
...
<table width="100%">
    ...
    <?php
	$i = 1;
    $sql = db::Query("SELECT * FROM painel_pedidos WHERE locutor='".$_SESSION['usuario_admin']."' ORDER BY id DESC LIMIT 50");
    ...
    <tr>
        ...
        <th<?php echo $css; ?>><?php echo $ver['habbo']; ?></th>
        <th<?php echo $css; ?>><?php echo $ver['mensagem']; ?></th>
