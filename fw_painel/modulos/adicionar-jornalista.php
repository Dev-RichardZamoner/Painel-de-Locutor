...
<div id="base_text_topo_local_pagina" class="text_barra_title_pagina">Noticiario / Adicionar jornalista</div>
<div id="content_title_pagina" class="title_pagina_barra">Adicionar jornalista</div>
</div>
...
$usuario = $_POST['usuario'];
	...
	if($_POST){
		if(empty($usuario)){
			...
			$usr_id = $row_o['id'];
			$sql2 =  mysql_query("INSERT INTO painel_usuario_rel(tp_usr_id, usr_id) VALUES('8','".$usr_id."')");
