...
<div id="base_text_topo_local_pagina" class="text_barra_title_pagina">Logs / Logs do site</div>
<div id="content_title_pagina" class="title_pagina_barra">Logs do site</div>
</div>
...
<table width="100%">
    ...
    <?php
	$i = 1;
    $sql = db::Query("SELECT * FROM logs_site ORDER BY id DESC LIMIT 50");
    ...
    <tr>
        ...
        <th<?php echo $css; ?>><?php echo $ver['pagina']; ?></th>
